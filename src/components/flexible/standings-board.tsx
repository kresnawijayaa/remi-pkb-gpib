...
import { allRoundResultsLocked, calculateStandings, expectedTableCount, scoringComplete } from "@/lib/flexible/scoring";
...
export function StandingsBoard({ event }: { event: EventRecord }) {
  ...
  const resultsLocked = allRoundResultsLocked(event.data);
