...
export function PublicBoard({ name, participants, draws, token }: { name: string; participants: PublicPerson[]; draws: Draw[]; shortCode?: string | null; token: string }) {
