      ...
      <section className="grid gap-4 lg:grid-cols-[1fr_300px]">
        <div className="border border-border bg-card p-4">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
            <Link href={`/tournaments-old/${tournamentId}/participants`} className={buttonClass({ variant: "outline", className: "justify-start" })}>
              Peserta
            </Link>
            <Link href={`/tournaments-old/${tournamentId}/communities`} className={buttonClass({ variant: "outline", className: "justify-start" })}>
              Komunitas
            </Link>
            <Link href={`/tournaments-old/${tournamentId}/import`} className={buttonClass({ variant: "outline", className: "justify-start" })}>
              Import CSV
            </Link>
            <Link href={`/tournaments-old/${tournamentId}/game`} className={buttonClass({ variant: "outline", className: "justify-start" })}>
              Permainan
            </Link>
            <Link href={`/tournaments-old/${tournamentId}/standings`} className={buttonClass({ variant: "outline", className: "justify-start" })}>
              Top klasemen
            </Link>
          </div>
        </div>
