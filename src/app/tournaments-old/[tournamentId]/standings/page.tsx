    ...
    <TournamentSectionShell tournamentId={tournamentId} tournament={tournament} summary={summary} activeSection="standings" showViewerButton={false}>
      <div className="flex items-center justify-between border-b border-border">
        <div className="flex gap-2">
          <Link
            href={`/tournaments-old/${tournamentId}/standings`}
          ...
          {tournament.isExhibition && (
            <Link
              href={`/tournaments-old/${tournamentId}/standings?tab=semifinal`}
          ...
          <Link
            href={`/tournaments-old/${tournamentId}/standings?tab=final`}
